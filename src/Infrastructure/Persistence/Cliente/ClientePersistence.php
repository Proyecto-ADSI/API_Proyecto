...
class ClientePersistence implements ClienteRepository
{
    ...
    public function ListarCliente(){
        $sql = "SELECT d.Id_Cliente, d.NIT_CDV, d.Razon_Social, d.Telefono, IFNULL(o.Nombre_Operador,'No especificado') Operador,
    ...
    public function ObtenerCliente(int $id){
        ...
        dbl.Razones, IFNULL(o.Id_Operador,'0') Id_Operador, IFNULL(o.Nombre_Operador,'No especificado') Nombre_Operador, o.Color, 
