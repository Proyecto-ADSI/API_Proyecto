...
class DBLPersistence implements DBLRepository
{
    ...
    public function RegistrarDBL(DBL $DBL){
        ...
        Id_Cliente,Id_Operador,Id_Plan_Corporativo,
        Encargado,Extension,Telefono_Contacto, Cantidad_Lineas,
        Valor_Mensual, Cantidad_Minutos, Cantidad_Navegacion, Llamadas_Internacionales,
        ...
        try {
            ...
            $stm->bindValue(6,$DBL->__GET("Telefono_Contacto"));
    ...
    public function ListarDBL(int $Id_DBL){
        ...
        $sql = "SELECT Id_DBL,Id_Cliente,Id_Operador,Id_Plan_Corporativo, Encargado,Extension,Telefono, Cantidad_Lineas, Valor_Mensual,
